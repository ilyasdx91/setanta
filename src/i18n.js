...
const messages = {
  en: {
    ...
    back: 'Back',
    finish: 'Finish',
    wrong_orientation: 'Please rotate your device to landscape mode to start the game.',
  ...
  uk: {
    ...
    back: 'Назад',
    finish: 'Завершити',
    wrong_orientation: 'Будь ласка, переверніть пристрій у альбомний режим, щоб розпочати гру.',
    return_correct_orientation: 'Щоб продовжити, поверніть пристрій у вихідне положення.',
